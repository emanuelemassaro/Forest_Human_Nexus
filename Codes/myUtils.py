...
# Set global font
mpl.rcParams['font.family'] = 'Liberation Sans'  # or 'Arial', 'Times New Roman', etc.
...
def add_legend(ax, patches, title, x=0.25, y=0.25):
...
def reproject_raster_to_4326(src):
    dst_crs = 'EPSG:4326'
